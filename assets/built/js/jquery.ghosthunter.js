...
(function ($) {
  ...
  */
  ...
  (function (root, factory) {
    ...
    function Levenshtein(str_m, str_n) {
      ...
      if (typeof str_m === "string" && typeof str_n === "string") {
        getElem = getChar;
      } else if ((typeof str_m === "undefined" ? "undefined" : _typeof(str_m)) === "object" && (typeof str_n === "undefined" ? "undefined" : _typeof(str_n)) === "object") {
      ...
      if (str_m == str_n) return this.distance = 0;else if (str_m == '') return this.distance = str_n.length;else if (str_n == '') return this.distance = str_m.length;else {
        ...
        forEach(str_n, function (n_val, n_idx) {
          ...
          forEach(str_m, function (m_val, m_idx) {
            m_idx++;
            if (getElem(str_m, m_idx - 1) == getElem(str_n, n_idx - 1)) current[m_idx] = previous[m_idx - 1];else current[m_idx] = Math.min(previous[m_idx] + 1 // Deletion
  ...
  var settleIDs = function settleIDs() {
  ...
  var updateSearchList = function updateSearchList(listItems, apiData, steps) {
