...
!function t(r, o, i) {
  function n(a, h) {
    if (!o[a]) {
      if (!r[a]) {
        var u = "function" == typeof require && require;if (!h && u) return u(a, !0);if (e) return e(a, !0);var s = new Error("Cannot find module '" + a + "'");throw s.code = "MODULE_NOT_FOUND", s;
      }var c = o[a] = { exports: {} };r[a][0].call(c.exports, function (t) {
        var o = r[a][1][t];return n(o ? o : t);
      }, c, c.exports, t, r, o, i);
    }return o[a].exports;
  }for (var e = "function" == typeof require && require, a = 0; a < i.length; a++) {
    n(i[a]);
  }return n;
}({ 1: [function (t, r, o) {
    if (!i) var i = { map: function map(t, r) {
        var o = {};return r ? t.map(function (t, i) {
          return o.index = i, r.call(o, t);
        }) : t.slice();
      }, naturalOrder: function naturalOrder(t, r) {
        return r > t ? -1 : t > r ? 1 : 0;
      }, sum: function sum(t, r) {
        var o = {};return t.reduce(r ? function (t, i, n) {
          return o.index = n, t + r.call(o, i);
        } : function (t, r) {
          return t + r;
        }, 0);
      }, max: function max(t, r) {
      ...
      function t(t, r, o) {
        ...
        function r() {
          o.sort(t), i = !0;
            ...
            i = !1;return { push: function push(t) {
            o.push(t), i = !1;
        ...
        var h = this;h.r1 = t, h.r2 = r, h.g1 = o, h.g2 = i, h.b1 = n, h.b2 = e, h.histo = a;
      }function n() {
        ...
        var o,
            ...
            e,
            a = 1 << 3 * s,
            h = new Array(a);return r.forEach(function (r) {
        ...
        var i,
            ...
            s = 0,
            p = 1e6,
            f = 0;return t.forEach(function (t) {
        ...
        function n(t) {
          var r,
              ...
              h = t + "1",
              u = t + "2",
              c = 0;for (s = o[h]; s <= o[u]; s++) {
            if (v[s] > A / 2) {
              for (n = o.copy(), e = o.copy(), r = s - o[h], i = o[u] - s, a = i >= r ? Math.min(o[u] - 1, ~~(s + i / 2)) : Math.max(o[h], ~~(s - 1 - r / 2)); !v[a];) {
                a++;
              }for (c = T[a]; !c && v[a - 1];) {
                c = T[--a];
          ...
          var e = o.r2 - o.r1 + 1,
              a = o.g2 - o.g1 + 1,
              h = o.b2 - o.b1 + 1,
              u = i.max([e, a, h]);if (1 == o.count()) return [o.copy()];var s,
              c,
              p,
              f,
              l,
        ...
        function u(t, r) {
          for (var o, i = 1, n = 0; p > n;) {
            if (o = t.pop(), o.count()) {
              var e = h(s, o),
                  a = e[0],
                  u = e[1];if (!a) return;if (t.push(a), u && (t.push(u), i++), i >= r) return;if (n++ > p) return;
            } else t.push(o), n++;
          }
        }if (!t.length || 2 > o || o > 256) return !1;var s = e(t),
            c = 0;s.forEach(function () {
          c++;
        });var l = a(t, s),
            A = new r(function (t, r) {
          return i.naturalOrder(t.count(), r.count());
        });A.push(l), u(A, f * o);for (var v = new r(function (t, r) {
          return i.naturalOrder(t.count() * t.volume(), r.count() * r.volume());
        }); A.size();) {
          v.push(A.pop());
        }u(v, o - v.size());for (var T = new n(); v.size();) {
          T.push(v.pop());
        }return T;
      }var s = 5,
          c = 8 - s,
          p = 1e3,
          f = .75;return o.prototype = { volume: function volume(t) {
          var r = this;return (!r._volume || t) && (r._volume = (r.r2 - r.r1 + 1) * (r.g2 - r.g1 + 1) * (r.b2 - r.b1 + 1)), r._volume;
        }, count: function count(r) {
          var o = this,
              i = o.histo;if (!o._count_set || r) {
            var n,
                e,
                a,
                h,
                u = 0;for (n = o.r1; n <= o.r2; n++) {
              for (e = o.g1; e <= o.g2; e++) {
                for (a = o.b1; a <= o.b2; a++) {
                  h = t(n, e, a), u += i[h] || 0;
                }
          ...
          var t = this;return new o(t.r1, t.r2, t.g1, t.g2, t.b1, t.b2, t.histo);
        }, avg: function avg(r) {
          var o = this,
              i = o.histo;if (!o._avg || r) {
            var n,
                e,
                a,
                h,
                ...
                f = 0,
                l = 0,
                A = 0;for (e = o.r1; e <= o.r2; e++) {
              for (a = o.g1; a <= o.g2; a++) {
                for (h = o.b1; h <= o.b2; h++) {
                  u = t(e, a, h), n = i[u] || 0, c += n, f += n * (e + .5) * p, l += n * (a + .5) * p, A += n * (h + .5) * p;
                }
              }
          ...
          var r = this,
              o = t[0] >> c;return gval = t[1] >> c, bval = t[2] >> c, o >= r.r1 && o <= r.r2 && gval >= r.g1 && gval <= r.g2 && bval >= r.b1 && bval <= r.b2;
          ...
          for (var r, o, i, n = this.vboxes, e = 0; e < n.size(); e++) {
            o = Math.sqrt(Math.pow(t[0] - n.peek(e).color[0], 2) + Math.pow(t[1] - n.peek(e).color[1], 2) + Math.pow(t[2] - n.peek(e).color[2], 2)), (r > o || void 0 === r) && (r = o, i = n.peek(e).color);
          }return i;
        }, forcebw: function forcebw() {
          var t = this.vboxes;t.sort(function (t, r) {
            return i.naturalOrder(i.sum(t.color), i.sum(r.color));
          });var r = t[0].color;r[0] < 5 && r[1] < 5 && r[2] < 5 && (t[0].color = [0, 0, 0]);var o = t.length - 1,
              n = t[o].color;n[0] > 251 && n[1] > 251 && n[2] > 251 && (t[o].color = [255, 255, 255]);
        } }, { quantize: u };
    ...
    (function () {
      var r,
        ...
        return function () {
          ...
          e = [].slice;window.Swatch = o = function () {
        function t(t, r) {
        ...
        function i(t, i, e) {
          this.swatches = n(this.swatches, this);var a, h, u, s, c, p, f, l, A, v, T, g;"undefined" == typeof i && (i = 64), "undefined" == typeof e && (e = 5), f = new r(t);try {
            for (l = f.getImageData(), T = l.data, v = f.getPixelCount(), h = [], p = 0; v > p;) {
              A = 4 * p, g = T[A + 0], c = T[A + 1], u = T[A + 2], a = T[A + 3], a >= 125 && (g > 250 && c > 250 && u > 250 || h.push([g, c, u])), p += e;
          ...
          var t;return void 0 === this.VibrantSwatch && void 0 !== this.DarkVibrantSwatch && (t = this.DarkVibrantSwatch.getHsl(), t[2] = this.TARGET_NORMAL_LUMA, this.VibrantSwatch = new o(i.hslToRgb(t[0], t[1], t[2]), 0)), void 0 === this.DarkVibrantSwatch && void 0 !== this.VibrantSwatch ? (t = this.VibrantSwatch.getHsl(), t[2] = this.TARGET_DARK_LUMA, this.DarkVibrantSwatch = new o(i.hslToRgb(t[0], t[1], t[2]), 0)) : void 0;
        }, i.prototype.findMaxPopulation = function () {
          var t, r, o, i, n;for (o = 0, i = this._swatches, t = 0, r = i.length; r > t; t++) {
            n = i[t], o = Math.max(o, n.getPopulation());
          }return o;
        }, i.prototype.findColorVariation = function (t, r, o, i, n, e) {
          var a, h, u, s, c, p, f, l, A;for (s = void 0, c = 0, p = this._swatches, a = 0, h = p.length; h > a; a++) {
            l = p[a], f = l.getHsl()[1], u = l.getHsl()[2], f >= n && e >= f && u >= r && o >= u && !this.isAlreadySelected(l) && (A = this.createComparisonValue(f, i, u, t, l.getPopulation(), this.HighestPopulation), (void 0 === s || A > c) && (s = l, c = A));
          }return s;
          ...
          var t, r, o, i, n, a;for (n = 1 <= arguments.length ? e.call(arguments, 0) : [], r = 0, o = 0, t = 0; t < n.length;) {
            i = n[t], a = n[t + 1], r += i * a, o += a, t += 2;
          }return r / o;
          ...
          var i, n, e, a, h, u;if (t /= 255, r /= 255, o /= 255, a = Math.max(t, r, o), h = Math.min(t, r, o), n = void 0, u = void 0, e = (a + h) / 2, a === h) n = u = 0;else {
            switch (i = a - h, u = e > .5 ? i / (2 - a - h) : i / (a + h), a) {case t:
                n = (r - o) / i + (o > r ? 6 : 0);break;case r:
                n = (o - t) / i + 2;break;case o:
                n = (t - r) / i + 4;}n /= 6;
          }return [n, u, e];
        }, i.hslToRgb = function (t, r, o) {
          var i, n, e, a, h, u;return u = void 0, n = void 0, i = void 0, e = function e(t, r, o) {
